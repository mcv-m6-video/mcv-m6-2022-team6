...
def create_csv(video_path, gt_path, patches_path, sequence, camera, writer):
...
if __name__ == "__main__":
    ...
    with open('Week5/gt/gt_car_patches_annotations.csv', 'w', newline='') as file:
        ...
        for seq in ['S03','S04','S01']:
            ...
            for camera in sorted(videos_path):
                ...
                create_csv(video_path, gt_path, patches_path, seq, camera, writer)
