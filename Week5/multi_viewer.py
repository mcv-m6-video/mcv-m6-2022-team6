...
def draw_boxes(image, boxes, tracker=None,  color='g', linewidth=5, det=False, boxIds=False, old=False):
    rgb = colors[color]
    for box in boxes:
        # print(box.id)
        if boxIds:
...
if __name__ == "__main__":
    params = {
        'data_path': "dataset/train/S03/",
        'det_path': "Week5/det/reid/06_3_5/"
    ...
    for cam in cams:
        ...
        det = read_detections2(params['det_path']+"{}/overlap_reid_detections.txt".format(cam), iou_th=0.4)
